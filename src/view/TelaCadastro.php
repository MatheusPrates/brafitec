            ...
            <div style="margin-left:15%;margin-right:10%;margin-top:5%">
                ...
                <div style="margin-top:5%">
                    <div class="row form-inline">
                        ...
                        <input type="text" style="width:15%;margin-left:10px" class="form-control">
                        <label for="login" style="padding-left:10px" class="control-label">Matrícula*: </label>
                        <input type="text" style="width:15%;margin-left:10px" class="form-control">
                        <label for="password" style="padding-left:10px" class="control-label">Senha*: </label>
                        <input type="text" style="width:15%;margin-left:10px" class="form-control">
                        <label for="password" style="padding-left:10px" class="control-label">Confirme a senha*: </label>
                        <input type="text" style="width:15%;margin-left:10px" class="form-control">
                    </div>
                    <p style="margin-top:10px"> Mais dados pessoais para preencher... </p>
                </div>
                <hr class="footer-hr">
                ...
                <div style="margin-top:5%">
                    <div class="row form-inline">
                        ...
                        <input type="text" style="width:10%;margin-left:10px" class="form-control">
                        <label for="password" style="padding-left:10px" class="control-label">CR acumulado*: </label>
                        <input type="text" style="width:10%;margin-left:10px" class="form-control">
                    </div>
                    <p style="margin-top:10px"> Mais dados acadêmicos para preencher... </p>
